...
void main()
{
    ...
    //Allow NPCs to restore their Bard Song if they have a variable set on them.
    if(!GetIsPC(OBJECT_SELF) && GetLocalInt(OBJECT_SELF, "FEAT_RESTORE_CHANCE"))
    {
        int nChance = GetLocalInt(OBJECT_SELF, "FEAT_RESTORE_CHANCE");
