...
int CIGetIsSpellRestrictedFromCraftFeat(int nSpellID, int nFeatID)
{
    ...
    //Greater Sanctuary, Heal, Mass Heal, Harm, Divine Power, Tenser's, and Magic Vestment
    if(nSpellID == 443 || nSpellID == 114 || nSpellID == 79 || nSpellID == 77 || nSpellID == 42 ||
    nSpellID == 184 || nSpellID == 546)
    {
        return TRUE;
    }
