...
// End of Spell Cast Hook
    ...
    eLink = EffectLinkEffects(eLink, EffectSpellImmunity(SPELL_ISAACS_LESSER_MISSILE_STORM));
    eLink = EffectLinkEffects(eLink, EffectSpellImmunity(SPELL_ISAACS_GREATER_MISSILE_STORM));
